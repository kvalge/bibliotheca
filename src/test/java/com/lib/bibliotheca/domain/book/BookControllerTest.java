...
class BookControllerTest {
    ...
    void addNewBook() {
        ...
        bookController.addNewBook(bookRequest);
    ...
    void getAllBooks() {
        ...
        List<BookDto> bookDtoList = bookController.getAllBooks();
    ...
    void getBookByName() {
        ...
        String bookName = bookController.getBookByName(name).getName();
    ...
    void updateBook() {
        ...
        bookController.updateBook(bookRequest);
    ...
    /**
     * Tests whether book entity's copy quantity saved to database and quantity updated in database via
    ...
    void updateCopyQuantity() {
        ...
        bookController.updateCopyQuantity(name, newQuantity);
    ...
    void deleteBook() {
        ...
        bookController.deleteBook(name);
