...
class LibraryUserServiceTest {
    ...
    void getAllUsers() {
        ...
        List<LibraryUserResponse> responseList = libraryUserService.getAllUsers();
    ...
    void getUserByIdCode() {
        ...
        LibraryUserResponse libraryUserResponse = libraryUserService.getUserByIdCode(requestIdCode);
    ...
    void deleteUser() {
        ...
        libraryUserService.deleteUser(requestIdCode);
